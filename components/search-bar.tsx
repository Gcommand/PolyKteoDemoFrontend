          ...
          <div className="flex-1 min-w-0">
            <MultiSelectDropdown
              options={[
                ...
                { value: "10", label: "Department of Chinese History and Culture" },
                { value: "11", label: "Department of Civil and Environmental Engineering" },
                { value: "12", label: "Department of Computing" },
                { value: "13", label: "Department of Data Science and Artificial Intelligence" },
                { value: "14", label: "Department of Electrical and Electronic Engineering" },
                { value: "15", label: "Department of Electronic and Information Engineering" },
                { value: "16", label: "Department of English and Communication" },
                { value: "17", label: "Department of Food Science and Nutrition" },
                { value: "18", label: "Department of Health Technology and Informatics" },
                { value: "19", label: "Department of Industrial and Systems Engineering" },
                ...
                { value: "24", label: "Department of Rehabilitation Sciences" },
                { value: "25", label: "School of Accounting and Finance" },
                { value: "26", label: "School of Design" },
                { value: "27", label: "School of Fashion and Textiles" },
                { value: "28", label: "School of Hotel and Tourism Management" },
                { value: "29", label: "School of Nursing" },
                { value: "30", label: "School of Optometry" },
                { value: "31", label: "Graduate School" },
                { value: "35", label: "Industrial Centre" },
                { value: "36", label: "Innovation and Technology Development Office" },
                { value: "37", label: "Research Institute of Innovative Products & Technologies" }
              ]}
